...
public class Vector3Tests
{
  ...
  public void Vector3ToStringTest()
  {
    ...
    string expectedv1 = string.Format(CultureInfo.CurrentCulture, "<{1:G}{0} {2:G}{0} {3:G}>", separator, 2, 3, 3.3);
  ...
  public void Vector3NormalizeTest2()
  {
    ...
    Vector3 actual = Vector3.Normalize(a);
    Assert.True(
      double.IsNaN(actual.X) && double.IsNaN(actual.Y) && double.IsNaN(actual.Z),
      "Vector3.Normalize did not return the expected value."
    );
  }
  ...
  public void Vector3ConstructorTest()
  {
    ...
    Assert.True(
      MathHelper.Equal(target.X, x) && MathHelper.Equal(target.Y, y) && MathHelper.Equal(target.Z, z),
      "Vector3.constructor (x,y,z) did not return the expected value."
    );
  }
  ...
  public void Vector3ConstructorTest1()
  {
    ...
    Vector3 target = new Vector3(a, z);
    Assert.True(
      MathHelper.Equal(target.X, a.X) && MathHelper.Equal(target.Y, a.Y) && MathHelper.Equal(target.Z, z),
      "Vector3.constructor (Vector2,z) did not return the expected value."
    );
  }
  ...
  public void Vector3ConstructorTest4()
  {
    ...
    Assert.True(
      ...
      "Vector3.constructor (Vector3) did not return the expected value."
    );
    Assert.True(
