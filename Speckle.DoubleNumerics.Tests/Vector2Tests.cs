...
public class Vector2Tests
{
  ...
  public void Vector2NormalizeTest1()
  {
    ...
    Assert.True(
      double.IsNaN(actual.X) && double.IsNaN(actual.Y),
      "Vector2.Normalize did not return the expected value."
    );
  }
  ...
  public void Vector2ConstructorTest()
  {
    ...
    Assert.True(
      ...
      "Vector2(x,y) constructor did not return the expected value."
    );
  }
